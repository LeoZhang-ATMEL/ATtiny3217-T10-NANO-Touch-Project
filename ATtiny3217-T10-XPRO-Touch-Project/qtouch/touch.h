 ...
 * filter level}
 */
//{X(13), X(6), X(1), X(2)}, Y(11), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), 
#define GRP_0_4P_PARAMS                                                                                                \
	{                                                                                                                  \
			{X(2), X(1), X(6), X(13)}, Y(11), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1),  \  
		    FILTER_LEVEL_16                                                                                            \
	}
#define GRP_1_4P_PARAMS                                                                                                \
	{                                                                                                                  \
		{X(2), X(1), X(6), X(13)}, Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1),     \
		    FILTER_LEVEL_16                                                                                            \
	}
